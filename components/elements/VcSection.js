...
export default class VcSection extends Component {
  render() {
    ...
    $output = <div className={$atts.content_width?$atts.content_width:'container'}>{$contentType==='object'&&<div className="row"><RenderElements elements={$content} /></div>}</div>;
